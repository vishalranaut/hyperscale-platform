"""HyperScale Platform — Notification Service Django Settings."""
...
ALLOWED_HOSTS = ["*"]
ROOT_URLCONF = "services.notification_service.urls"
ASGI_APPLICATION = "services.notification_service.asgi.application"
