"""HyperScale Platform — Analytics Service Settings."""
...
ALLOWED_HOSTS = ["*"]
ROOT_URLCONF = "services.analytics_service.urls"
ASGI_APPLICATION = "services.analytics_service.asgi.application"
